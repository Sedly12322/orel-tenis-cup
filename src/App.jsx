...
function App() {
  ...
  if (view === 'match' && score) {
    ...
    return (
      <div style={{ textAlign: 'center', padding: '20px', fontFamily: 'sans-serif', background: '#f4f7f6', minHeight: '100vh' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '30px', padding: '0 20px' }}>
          ...
          <div style={{ flex: '1 1 400px', background: score.server === 1 ? '#e2f0d9' : '#fff', border: score.server === 1 ? '6px solid #28a745' : '6px solid transparent', padding: '40px', borderRadius: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', display: 'flex', flexDirection: 'column' }}>
            ...
            {zamknoutJmena ? (
              <h2 style={{fontSize: '40px', margin: '10px 0 30px 0'}}>{score.player1_name}</h2>
            ) : (
              <select value={score.player1_name || 'Hráč 1'} onChange={(e) => zmenitJmenoHrace('player1_name', e.target.value)} style={{ fontSize: '32px', fontWeight: 'bold', textAlign: 'center', width: '100%', padding: '15px', marginBottom: '20px', border: '2px solid #ccc', borderRadius: '10px', background: '#fff' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-around', background: '#f8f9fa', padding: '20px', borderRadius: '15px', marginBottom: '30px' }}>
              <div><span style={{ fontSize: '24px', color: '#888' }}>Sety</span><br/><strong style={{ fontSize: '40px' }}>{score.sets_won?.player1 || 0}</strong></div>
              <div><span style={{ fontSize: '24px', color: '#888' }}>Gemy</span><br/><strong style={{ fontSize: '50px', color: '#007bff' }}>{score.current_set?.player1_games || 0}</strong></div>
            </div>
            
            <div style={{ fontSize: '140px', margin: '20px 0', fontWeight: 'bold', lineHeight: '1' }}>{score.current_game.player1_points}</div>
          ...
          <div style={{ flex: '1 1 400px', background: score.server === 2 ? '#e2f0d9' : '#fff', border: score.server === 2 ? '6px solid #28a745' : '6px solid transparent', padding: '40px', borderRadius: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', display: 'flex', flexDirection: 'column' }}>
            ...
            {zamknoutJmena ? (
              <h2 style={{fontSize: '40px', margin: '10px 0 30px 0'}}>{score.player2_name}</h2>
            ) : (
              <select value={score.player2_name || 'Hráč 2'} onChange={(e) => zmenitJmenoHrace('player2_name', e.target.value)} style={{ fontSize: '32px', fontWeight: 'bold', textAlign: 'center', width: '100%', padding: '15px', marginBottom: '20px', border: '2px solid #ccc', borderRadius: '10px', background: '#fff' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-around', background: '#f8f9fa', padding: '20px', borderRadius: '15px', marginBottom: '30px' }}>
              <div><span style={{ fontSize: '24px', color: '#888' }}>Sety</span><br/><strong style={{ fontSize: '40px' }}>{score.sets_won?.player2 || 0}</strong></div>
              <div><span style={{ fontSize: '24px', color: '#888' }}>Gemy</span><br/><strong style={{ fontSize: '50px', color: '#007bff' }}>{score.current_set?.player2_games || 0}</strong></div>
            </div>
            
            <div style={{ fontSize: '140px', margin: '20px 0', fontWeight: 'bold', lineHeight: '1' }}>{score.current_game.player2_points}</div>
